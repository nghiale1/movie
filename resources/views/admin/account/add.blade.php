                ...
                <form role="form" action="{{ route('account.store') }}" method="POST">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="username" class="form-control" id="username" name="username" placeholder="Nhập email">
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="form-group">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="checkbox" value="0" id="sex" name="sex" style="margin-left:15px;" checked>
                            <label>Nam</label>
