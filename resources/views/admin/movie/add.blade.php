        ...
        <div class="col-md-12">
            ...
            <div class="card card-primary">
                ...
                <form role="form" action="{{ route('movie.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <label for="id_discount">Giảm giá</label>
                            <select class="form-control" name="id_typemv">
                                <option>Chọn loại giảm giá</option>
                                @foreach ($discount as $item)
                                  <option value="{{ $item->id_discount }}"> {{ $item->detail_discount }} </option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="director" name="director" placeholder="Nhập tên đạo diễn phim">
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="form-group">
                            <label for="performers">Diễn viên</label>
                            <input type="text" class="form-control" id="performers" name="performers" placeholder="Nhập tên diễn viên">
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="form-group">
                            <label for="time_mv">Thời lượng phim</label>
                            <input type="text" class="form-control" id="time_mv" name="time_mv" placeholder="Nhập thời lượng phim">
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="form-group">
                            <label for="mv_content">Nội dung phim</label>
                            <textarea class="form-control" id="mv_content" name="mv_content" placeholder="Nhập nội dung phim"></textarea>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="form-group">
