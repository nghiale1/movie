...
Route::prefix('quan-tri')->group(function () {
     ...
     Route::prefix('phim')->group(function () {
        ...
        Route::get('/chinh-sua/{id}', [MovieController::class, 'edit'])->name('movie.edit');
        Route::post('/xu-ly-sua/{id}', [MovieController::class, 'update'])->name('movie.update');
        Route::get('/xoa/{id}', [MovieController::class, 'destroy'])->name('movie.destroy');
    });
    //Loại phim
    ...
    Route::prefix('banner')->group(function () {
        ...
        Route::get('/chinh-sua/{id}', [BannerController::class, 'edit'])->name('movie-banner.edit');
        Route::post('/xu-ly-sua/{id}', [BannerController::class, 'update'])->name('movie-banner.update');
        Route::get('/xoa/{id}', [BannerController::class, 'destroy'])->name('movie-banner.destroy');
    });
    //Giảm giá
